...
:paper:  Leijie Wu, Song Guo, Junxiao Wang, Zicong Hong,  Jie Zhang, and Yaohong Ding, Federated unlearning: Guarantee the right of clients to forget, IEEE Network  2022.
"""
...
class ClientFedGA(Client): 
    def __init__(self, global_dataset: Dataset, data_indices: List[int], local_model: nn.Module, client_id: int = 0, comm: Communicator = Communicator(), unlearning_indices: List[int] = [], args=None):
        ...
        :param unlearning_indices: Indices of data points to be unlearned
